...
function scene:create(event)
    ...
    -- | 11 = 2 | 21 = 3 | 31 = 4 | 41 = 5 | 51 = 6 | 61 = 7 | 71 = 8
    ...
    local m1 = mBTN.new({
        ...
        id = 1,
        userId = userId,
        sprite = "assets/7items/frog.png",
        stars = 0,
        title = "Comum",
        subtitle = "Monte Kiyama de Treino",
        energy = 40,
        onTap = function()
            cloudOn.show({
                time = 300
            ...
            timer.performWithDelay(300, function()
                composer.gotoScene("journey.journeyFormation", {
                    params = {
                        op = "journey.specialChapters.specialOpponents.frog_1",
                        ...
                        userId = userId,
                        needed = 40,
                        returnTo = "journey.specialChapters.monte_kiyama_de_treino"
                    }
                })
            end)
            timer.performWithDelay(300, function()
    ...
    local m2 = mBTN.new({
        x = display.contentCenterX,
        y = 90 + 150,
        id = 41, -- desbloqueia cap 3
        userId = userId,
        sprite = "assets/7items/frog_purple.png",
        stars = 0,
        title = "Elite",
        subtitle = "Monte Kiyama de Treino",
        energy = 60,
        onTap = function()
            ...
            timer.performWithDelay(300, function()
                composer.gotoScene("journey.journeyFormation", {
                    params = {
                        op = "journey.specialChapters.specialOpponents.frog_2",
                        form = "opponent_", -- opponent_ | boss_,
                        bg = 2,
                        title = "Elite",
                        subtitle = "Monte Kiyama de Treino",
    ...
    local m3 = mBTN.new({
        x = display.contentCenterX,
        y = 90 + 150 * 2,
        id = 71, -- libera apos vencer a jornada 6-10
        userId = userId,
        sprite = "assets/7items/frog_purple.png",
        stars = 0,
        title = "Herói",
        ...
        onTap = function()
            ...
            timer.performWithDelay(300, function()
                composer.gotoScene("journey.journeyFormation", {
                    params = {
                        op = "journey.specialChapters.specialOpponents.frog_3",
                        form = "opponent_", -- opponent_ | boss_,
                        bg = 2,
                        title = "Elite",
                        subtitle = "Monte Kiyama de Treino",
