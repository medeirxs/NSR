...
formation1[1] = {
    ...
    cri = 0,
    res = 0,
    card_image = {"assets/7sprites/journey/frog_blue.png", "assets/7sprites/journey/frog_blue.png",
                  "assets/7sprites/journey/frog_blue.png"},
    ab = "water_liberation",
    sp = "water_liberation",
    card_type = "bal",
    name = "Oponente",
...
formation3[1] = {
    ...
    cri = 0,
    res = 0,
    card_image = {"assets/7sprites/journey/frog_purple.png", "assets/7sprites/journey/frog_purple.png",
                  "assets/7sprites/journey/frog_purple.png"},
    ab = "water_liberation",
    sp = "water_liberation", -- mudar para water_Wall
    card_type = "bal",
    name = "Oponente",
    index = 1,
    stars = 8,
