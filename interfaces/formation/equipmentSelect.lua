...
local function populateList()
    ...
    supabaseClient:request("GET", string.format("user_characters?userId=eq.%d&order=stars.desc,name",
        params.userId or 461752844), nil, function(event)
...
function scene:create(event)
    ...
    local bg = display.newImageRect(self.view, "assets/7bg/bg_yellow_large.jpg", display.contentWidth,
