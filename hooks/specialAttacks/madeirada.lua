...
local hitAnimScale = 0.8
local zoomInAnimScale = 2  -- Controle de escala para a animação de zoom in

-- Configuração da spritesheet de zoom in (efeito extra)
local zoomInSheetOptions = {
    frames = {
        { x = 1,   y = 1,   width = 180, height = 98 },
        { x = 183, y = 1,   width = 200, height = 100 },
        { x = 1,   y = 103, width = 200, height = 100 },
        { x = 203, y = 103, width = 200, height = 100 },
        { x = 1,   y = 205, width = 200, height = 100 },
        { x = 203, y = 205, width = 200, height = 100 },
        { x = 1,   y = 307, width = 200, height = 100 },
        { x = 203, y = 307, width = 200, height = 100 },
        { x = 385, y = 1,   width = 200, height = 100 },
        { x = 405, y = 103, width = 200, height = 100 },
    }
}
local zoomInSheet = graphics.newImageSheet("assets/7effect/action_55.png", zoomInSheetOptions)
...
local hitSheetOptions = {
    frames = {
      { x = 1,   y = 1,    width = 193, height = 111 },
      { x = 196, y = 1,    width = 326, height = 304 },
      { x = 524, y = 1,    width = 413, height = 368 },
      { x = 1,   y = 371,  width = 435, height = 403 },
      { x = 438, y = 371,  width = 447, height = 438 },
      { x = 939, y = 1,    width = 446, height = 455 },
      { x = 887, y = 458,  width = 445, height = 468 },
      { x = 1,   y = 928,  width = 447, height = 465 },
    }
}
local hitSheet = graphics.newImageSheet("assets/7effect/bullet_112.png", hitSheetOptions)
