...
local function showHealEffect(targetGroup, callback)
    local healSheetOptions = {
        frames = {
            { x = 1214, y = 2, width = 112, height = 112 },
            { x = 402,  y = 2, width = 120, height = 114 },
            { x = 794,  y = 2, width = 140, height = 114 },
            { x = 1410, y = 2, width = 144, height = 110 },
            { x = 1556, y = 2, width = 138, height = 108 },
            { x = 936,  y = 2, width = 138, height = 114 },
            { x = 1076, y = 2, width = 136, height = 114 },
            { x = 656,  y = 2, width = 136, height = 116 },
            { x = 518,  y = 2, width = 136, height = 116 },
            { x = 266,  y = 2, width = 134, height = 120 },
            { x = 134,  y = 2, width = 130, height = 122 },
            { x = 2,    y = 2, width = 130, height = 122 },
            { x = 1696, y = 2, width = 130, height = 102 },
        }
    }
    ...
    transition.to(actionEffect, {
        ...
        onComplete = function()
            transition.to(actionEffect, {
                ...
                alpha = 0,
                onComplete = function()
                    if actionEffect.removeSelf then actionEffect:removeSelf() end
                    ...
                    if targetAlly then
                        ...
                        if battleFunctions.updateHealthBar then
                            ...
                            print("healTechnique: updateHealthBar não disponível para " .. (targetAlly.name or "sem nome"))
                        end
                        ...
                        if targetAlly.group then
                            showHealEffect(targetAlly.group, function()
                                print("healTechnique: Efeito de cura concluído para " .. (targetAlly.name or "sem nome"))
