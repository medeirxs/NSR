...
local hitSheetOptions = {
    frames = {
        { x = 1,    y = 1,    width = 237, height = 193 },
        { x = 240,  y = 1,    width = 235, height = 197 },
        { x = 477,  y = 1,    width = 231, height = 197 },
        { x = 710,  y = 1,    width = 237, height = 197 },
        { x = 1,    y = 200,  width = 237, height = 197 },
        { x = 240,  y = 200,  width = 239, height = 197 },
        { x = 481,  y = 200,  width = 243, height = 197 },
        { x = 726,  y = 200,  width = 239, height = 197 },
        { x = 1,    y = 399,  width = 241, height = 197 },
        { x = 244,  y = 399,  width = 239, height = 197 },
        { x = 485,  y = 399,  width = 245, height = 197 },
        { x = 732,  y = 399,  width = 239, height = 197 },
        { x = 1,    y = 598,  width = 241, height = 197 },
        { x = 244,  y = 598,  width = 237, height = 197 },
        { x = 483,  y = 598,  width = 241, height = 197 },
        { x = 726,  y = 598,  width = 241, height = 197 },
        { x = 949,  y = 1,    width = 241, height = 193 },
        { x = 967,  y = 196,  width = 239, height = 195 },
        { x = 973,  y = 393,  width = 239, height = 193 },
        { x = 973,  y = 588,  width = 243, height = 197 },
    }
}
...
local function playUpAnimation(cardGroup, callback)
    ...
    transition.to(upSprite, { delay = 500 - 10, time = 200, alpha = 0 })  -- fade out inicia 10 ms antes do fim
    upSprite:play()
            ...
            playUpAnimation(cardGroup, function()
                ...
                transition.to(cardGroup, {
                    ...
                    onComplete = function()
                        ...
                        hitSprite:toFront()
                        hitSprite.alpha = 0
                        transition.to(hitSprite, { time = 300, alpha = 0.8 })
