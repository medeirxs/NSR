...
-- Largura de referência para o design (pode ser ajustada conforme necessário)
...
local hitEffectScale = 2.9 * deviceScaleFactor
...
local function playProjectileAnimation(attacker, target, battleFunctions, callback)
    ...
    -- Escala responsiva para o projetil (valor base 3 multiplicado pelo fator responsivo)
    projectileSprite:scale(3 * deviceScaleFactor, 3 * deviceScaleFactor)
    ...
    playAttackerAnimation(cardGroup,
        function()  -- Callback para disparar o projetil durante a animação
            ...
            playProjectileAnimation(attacker, target, battleFunctions, function()
                ...
                -- Após o término do projetil, dispara o hit effect
                local targetGroup
